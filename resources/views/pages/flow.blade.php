            ...
            <!-- banner-page -->
               ...
               <!-- content-main -->
                <div class="content-main">
                     <h3 class="title-flow">
                        初めて導入やお問い合わせ<br class="sp-br">を検討されている皆様に、<br>下記のフローでご案内しております。
                     </h3>
                            ...
                            <li class="item-flow">
                                <div class="inner">
                                    <dl class="dl-info">
                                        ...
                                        <dd class="dd-info">まずはお気軽にお問い合わせください。お問い合わせは当社のお問い合わせフォームまたはお電話にて受け付けております。ご不明点やご相談がございましたらどんな些細なことでも構いませんので、お気軽にご連絡ください。担当者が迅速に対応し、ご要望に応じた最適なご提案をさせていただきます。</dd>
                                    </dl>
                                    <p class="img-icon">
                                        <picture>
                            ...
                            <li class="item-flow">
                                <div class="inner">
                                    <dl class="dl-info">
                                        ...
                                        <dd class="dd-info">ヒアリングでお伺いした内容をもとに、お見積もりを作成・提出いたします。<br>料金体系や契約形態、サービス内容についても詳細にご説明し、ご不明点があれば丁寧にお答えいたします。お客様のご予算やご要望に応じて、最適なプランをご提案させていただきますので、ご納得いただいた上で次のステップへと進めます。</dd>
                                    </dl>
                                    <p class="img-icon">
                                        <picture>
                            ...
                            <li class="item-flow">
                                <div class="inner">
                                    <dl class="dl-info">
                                        ...
                                        <dd class="dd-info">契約締結後、お客様のご要望に合った候補者の選定を開始いたします。<br>当社のデータベースやネットワークを活用し、経験・スキル・人柄を総合的に判断しながら最適な人材をご紹介いたします。選考にあたっては、企業様の求める人物像に合致するかどうかを慎重にチェックし、最適な候補者をピックアップいたします。</dd>
                                    </dl>
                                    <p class="img-icon">
                                        <picture>
